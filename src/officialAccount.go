...
type MediaXPluginWechatOfficialAccount struct {
	PluginName string
...
func (p *MediaXPluginWechatOfficialAccount) Initialize(ctx *context.Context, arg interface{}) error {
...
func (p *MediaXPluginWechatOfficialAccount) Name(ctx *context.Context) string {
	return p.PluginName
}

func (p *MediaXPluginWechatOfficialAccount) Publish(ctx *context.Context, arg interface{}) (interface{}, error) {
...
var PluginMediaXWechatOfficialAccount MediaXPluginWechatOfficialAccount = NewMediaXPluginWechatOfficialAccount()
